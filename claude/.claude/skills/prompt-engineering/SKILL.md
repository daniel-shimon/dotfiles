...
description: Use when writing or improving skills that give instructions to agents, writing commands/hooks for Claude Code, writing prompts for subagents or any LLM interaction, optimizing prompts, or designing production prompt templates.
---
