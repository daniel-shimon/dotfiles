...
allowed-tools: Bash(osascript:*), Bash(push-ping*)
---
...
Note: The `&` makes osascript return immediately. Always call `push-ping` (no args) after osascript to also send a push notification.
